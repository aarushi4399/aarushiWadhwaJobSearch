...
<body>
    ...
    <section class="pilot">
        <div class="container align-items-center">
            ...
            <center>
                ...
                <h1 class="entry-1">FOR VENDORS</h1>
    ...
    <div class="container" style="margin-top: 80px; margin-bottom: 100px">
        ...
        <br>
        <form method="POST" action="./private\controllers/loginV.php">
            ...
            <br>
            <small style="font-size: 14px;">Don't have an account? <a href="./vendors.php#register">Sign up</a></small>
        </form>
    </div>
